...
const History = () => {
  ...
  const filteredCompanies = pastCompanies.filter((company) => {
    const nameMatch = company.name?.toLowerCase().includes(searchQuery.toLowerCase());
    const industryMatch = company.industry?.toLowerCase().includes(searchQuery.toLowerCase());
    const statusMatch = company.status?.toLowerCase().includes(searchQuery.toLowerCase());
    ...
    <div className="p-8 max-w-7xl mx-auto animate-fade-in">
      ...
      <div className="grid gap-6">
        {isLoading ? (
          ...
          <div className="text-center text-gray-500 py-8">No matching history found.</div>
